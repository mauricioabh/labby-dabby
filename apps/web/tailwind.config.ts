...
import { spacing, typography } from '@labby-dabby/ui';
...
const config: Config = {
  ...
  theme: {
    extend: {
      fontFamily: {
        sans: ['var(--font-sans)', typography.fontFamily.sans, 'system-ui', 'sans-serif'],
        mono: ['var(--font-mono)', typography.fontFamily.mono, 'monospace'],
      },
      fontSize: {
